...
const  Sidenav = () => {
    return(
        ...
        <div className="md:w-full md:sticky md:top-16 md:z-0 top-0 z-20 fixed bg-gray-200">
        {/* container */}
        
        <aside className="flex flex-col items-center bg-white text-gray-700 shadow fixed h-full">
          {/* Side Nav Bar*/}
